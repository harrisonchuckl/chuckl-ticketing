...
const organiserId = isOrganiser(req) ? requireUserId(req) : String(req.body?.organiserId || requireUserId(req));
    ...
    const created = await prisma.show.create({
      data: {
        ...
        videoUrlOne: asNullableString(videoUrlOne),
        videoUrlTwo: asNullableString(videoUrlTwo),
...
organiserId: effectiveOrganiserId,
  ...
  ...(slugToSet ? { slug: slugToSet } : {}),
        ...
        ...(videoUrlOne !== undefined ? { videoUrlOne: asNullableString(videoUrlOne) } : {}),
        ...(videoUrlTwo !== undefined ? { videoUrlTwo: asNullableString(videoUrlTwo) } : {}),
  ...
  try {
    ...
    const newShow = await prisma.show.create({
      data: {
        ...
        videoUrlOne: src.videoUrlOne,
        videoUrlTwo: src.videoUrlTwo,
        date: src.date,
        endDate: src.endDate,
