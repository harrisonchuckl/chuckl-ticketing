  ...
  try {
    ...
    const created = await prisma.promoter.create({
      data: {
        ...
        weeklyReportEmail: toNullableString(req.body?.weeklyReportEmail),
        weeklyReportTime: toNullableString(req.body?.weeklyReportTime),
        weeklyReportDay: toNullableString(req.body?.weeklyReportDay),
