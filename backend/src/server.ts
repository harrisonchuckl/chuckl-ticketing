...
import adminPromotersRouter from "./routes/admin-promoters.js";
...
import adminHomeWidgetsRouter from "./routes/admin-home-widgets.js";
...
app.use("/admin", adminPromotersRouter);
...
app.use("/admin-ui", adminHomeWidgetsRouter);
